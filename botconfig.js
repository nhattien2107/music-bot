module.exports = {
  ...
  Token: process.env.Token || "OTkzMzM4MDk1Njg2NjU2MDYw.GzTfTl.l7PM9VjHq42tsaoaaU9lFgUnEnitJH3-CdHLic", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "993338095686656060", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "V1_twq7hSNqpMcuikbbdf7VvkYyRlkHN", // Discord Client Secret
  ...
  Lavalink: {
    ...
    host: "54.38.198.24", //- The host name or IP of the lavalink server.
    port: 88, // The port that lavalink is listening to. This must be a number!
    pass: "stonemusicgay", //- The password of the lavalink server.
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "419420010d5645e998faf5d2f7b3b173", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "2304870966f14d7b8de9d12797c59b89", // Spotify Client Secret
  },
};
